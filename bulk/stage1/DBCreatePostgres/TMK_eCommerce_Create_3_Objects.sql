/*
Script generated by Aqua Data Studio 9.0.16 on Sep-29-2011 03:54:06 PM
Database: null
Schema: <All Schemas>
*/
...
CREATE TABLE Designs  (
	...
	AWSBucket       	varchar(512) NOT NULL,
	FlagDeleted     	boolean NOT NULL,
	CreationDate    	timestamp NOT NULL,
	LastUpdateDate  	timestamp NULL,
	DeletionDate    	timestamp NULL,
...
COMMENT ON TABLE Designs IS 'This table stores the different designs (look&feel).';
COMMENT ON COLUMN Designs.DesignStatus IS 'Indicates the status of the design (beta test, production, development, etc)';
COMMENT ON COLUMN Designs.AWSBucket IS 'The AWS S3 Bucket in use by the design';
...
CREATE TABLE URLPublishedStatus  (
	...
	PRIMARY KEY(URLId,DesignId)
);
COMMENT ON TABLE URLPublishedStatus IS 'This table indicates what URLs are published in what designs.';
...
ALTER TABLE URLPublishedStatus
	ADD CONSTRAINT FK_Designs_URLPublishedStatus
...
CREATE INDEX URLPublishedStatus_Idx_DesignURL
	ON URLPublishedStatus(DesignId, URLId)
	;
...
CREATE INDEX URLPublishedStatus_Idx_StatusDesignURL
	ON URLPublishedStatus(PublishedStatus, DesignId, URLId)
	;
